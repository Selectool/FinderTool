...
async def handle_send_message_error(error: Exception, user_id: int, db: Database) -> bool:
    """
...
async def safe_send_message(bot, user_id: int, text: str, db: Database, **kwargs) -> bool:
    """
...
async def safe_send_document(bot, user_id: int, document, db: Database, **kwargs) -> bool:
    """
...
async def safe_answer_message(message, text: str, db: Database, **kwargs) -> bool:
    """
...
async def safe_edit_message(message, text: str, db: Database, **kwargs) -> bool:
    """
