...
async def update_broadcast_counters(db: Database, broadcast_id: int, sent_count: int, failed_count: int):
...
async def enhanced_send_broadcast_task(db: Database, broadcast_id: int, broadcast: Dict[str, Any]):
