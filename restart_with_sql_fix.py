#!/usr/bin/env python3
"""
Перезапуск с исправлением SQL синтаксиса для PostgreSQL
"""
import subprocess
import sys
import os
...
class SQLFixManager:
    ...
    def start_admin(self):
        """Запуск админ-панели с исправленным SQL синтаксисом"""
        try:
            print("🌐 Запуск админ-панели с исправленным SQL синтаксисом...")
    ...
    def monitor_services(self):
        ...
        print("🔧 Исправлены проблемы с SQL синтаксисом:")
        print("   • SQLite: используется ? для параметров")
        print("   • PostgreSQL: используется $1, $2 для параметров")
        print("   • Исправлен синтаксис для обоих типов БД")
    ...
    def run(self):
        ...
        print("🚀 Перезапуск с исправлением SQL синтаксиса...")
        print("🔧 Исправления:")
        print("   • Исправлен SQL синтаксис для PostgreSQL ($1, $2)")
        print("   • Исправлен SQL синтаксис для SQLite (?)")
        print("   • Правильное определение типа БД")
        ...
        try:
            ...
            print("🎉 Все сервисы запущены с исправленным SQL!")
            print("🤖 Telegram бот: активен")
            print("🌐 Админ-панель: http://185.207.66.201:8080")
            print("🔑 Логин: admin / admin123")
            print("✅ SQL синтаксис исправлен для PostgreSQL!")
