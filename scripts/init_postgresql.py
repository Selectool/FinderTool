...
async def init_postgresql_database():
    ...
    try:
        ...
        # Инициализируем Database объект для создания дополнительных таблиц
        logger.info("🏗️ Создание дополнительных таблиц...")
        db = Database()
        await db.create_tables_if_not_exist()
        logger.info("✅ Дополнительные таблицы созданы")
