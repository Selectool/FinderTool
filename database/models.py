...
class Database:
    ...
    async def init_db(self):
        ...
        # Legacy AdminMigrations отключены в production
        # Используется новая unified система миграций
        logger.info("Legacy AdminMigrations отключены - используется unified система")
